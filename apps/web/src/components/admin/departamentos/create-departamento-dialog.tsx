...
export function CreateDepartamentoDialog({ onClose }: Props) {
  ...
  return (
    ...
    >
      <div className="bg-slate-900 border border-slate-700 rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
        <h2 className="text-base font-semibold text-slate-100 mb-5">Novo Departamento</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              {...register('descricao')}
              rows={2}
              placeholder="Descreva o que este departamento representa..."
          ...
          <div className="flex gap-3 justify-end pt-2">
            ...
            >
              {create.isPending ? 'Criando…' : 'Criar Departamento'}
            </button>
          </div>
        </form>
      </div>
