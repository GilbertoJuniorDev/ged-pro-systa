...
export function EditDossieDialog({ dossie, onClose }: Props) {
  const update = useUpdateDossie();
  ...
  return (
    ...
    >
      <div className="bg-slate-900 border border-slate-700 rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
        <h2 className="text-base font-semibold text-slate-100 mb-1">Editar Dossiê</h2>
        <p className="text-xs text-slate-500 mb-5">
          Departamento: <span className="text-slate-400">{departamentoNome}</span>
        </p>
