  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-full md:w-1/2 lg:w-5/12 flex flex-col justify-center px-8 sm:px-16 py-12 relative z-10 bg-white dark:bg-slate-900 animate-fade-in">
        ...
        {/* Formulário */}
        <div key={view} className="w-full max-w-sm mx-auto mt-12 animate-slide-up">
          {view === 'login' ? (
      ...
      <div className="hidden md:flex flex-1 bg-slate-900 dark:bg-slate-950 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 max-w-lg px-12 text-center">
          ...
          <p className="text-lg text-slate-300 dark:text-slate-400 font-light">
            Centralize, organize e acesse todos os arquivos da sua empresa com segurança de ponta a ponta e alta disponibilidade.
          </p>
