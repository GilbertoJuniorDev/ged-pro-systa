...
import { DossieList } from '@/components/documents/dossie-list';
import { CreateDossieDialog } from '@/components/documents/create-dossie-dialog';

export function DossiesPageClient() {
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-slate-50 p-4 sm:p-6 lg:p-8 dark:bg-slate-950">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-950 dark:text-slate-100">Dossiês</h2>
          <p className="text-slate-600 dark:text-slate-400">
            Agrupe documentos relacionados a um mesmo assunto em um dossiê, vinculado a um
            departamento.
          </p>
        </div>
        <button
