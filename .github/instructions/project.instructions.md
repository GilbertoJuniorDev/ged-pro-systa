...
| Arquivo | Escopo `applyTo` | O que cobre |
|---|---|---|
| [`backend.instructions.md`](./backend.instructions.md) | `apps/api/**` | NestJS, Clean Architecture, Repository Pattern, CQRS, Adapter, response format |
| [`frontend.instructions.md`](./frontend.instructions.md) | `apps/web/**` | Next.js App Router, Server vs Client Components, TanStack Query, Auth.js |
| [`database.instructions.md`](./database.instructions.md) | `packages/@ged/database/**` | Entidades TypeORM, migrations, snake_case conventions |
| [`testing.instructions.md`](./testing.instructions.md) | `**/*.spec.ts` | Jest, Supertest, Playwright, pirâmide de testes, cobertura 80% |
| [`infra.instructions.md`](./infra.instructions.md) | `infra/**` | Docker Compose, Dockerfiles multi-stage, healthchecks |

## Documentação de Referência (docs/)

| Arquivo | O que cobre |
|---|---|
| [`docs/ARCHITECTURE.md`](../../docs/ARCHITECTURE.md) | Arquitetura completa com todos os detalhes, diagramas e exemplos de código |
| [`docs/ENVIRONMENT.md`](../../docs/ENVIRONMENT.md) | `.env.example` template + schema Zod de validação de variáveis |
| [`docs/CONTRIBUTING.md`](../../docs/CONTRIBUTING.md) | Git Flow, Conventional Commits, regras de PR |
| [`docs/SCRIPTS.md`](../../docs/SCRIPTS.md) | Scripts pnpm, pipeline Turborepo, setup inicial |
...
- Monorepo: `apps/web` (Next.js 16.2) + `apps/api` (NestJS 11) + `packages/@ged/*`
- Infraestrutura: PostgreSQL 17 + Redis 7 + Docker Compose v2
...
| ORM | TypeORM 0.3 | Decorators TypeScript nativos, migrations automáticas |
...
| Storage | Adapter Pattern | Troca local ↔ S3 sem alterar código de negócio |

---

*Para a documentação de arquitetura completa, consulte [`docs/ARCHITECTURE.md`](../../docs/ARCHITECTURE.md)*
